...
wd <- 'C:/Users/givens/Box/WQIP-Annual-Report-2023-24/OutfallAssessments'
...
#Rain_Daily <-"OutfallAssessments/DryWeatherLoadingCalcs/Input/Rain/Rain_SOCWMA_COOP_2015-2024.csv"

Rain_Daily <-paste0(inPath, 'Rain_SOCWMA_COOP_2015_2024.csv')
...
dry_days_year$MonitoringYear<- ifelse(dry_days_year$Date>(as.Date("2023-09-30", origin="1900-01-01")) & dry_days_year$Date<(as.Date("2024-10-01", origin="1900-01-01")), "MY2023-24",
  ifelse(dry_days_year$Date>(as.Date("2022-09-30", origin="1900-01-01")) & dry_days_year$Date<(as.Date("2023-10-01", origin="1900-01-01")), "MY2022-23",
