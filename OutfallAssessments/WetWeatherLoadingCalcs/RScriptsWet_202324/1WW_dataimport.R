...
emc1<- paste0(wd, '/WetWeatherLoadingCalcs/Input/WetWeatherDataandSALsAssessment2023-24.xlsx')
...
#%>%
  ...
  #mutate('Collected Date' = as.Date('Collected Date', format = '%m/%d/%Y')) %>%
  #mutate('Composite Start Time' = as.Date('Composite Start Time', format = '%m/%d/%Y')) %>% 
  #mutate('Composite End Time' = as.Date('Composite End Time', format = '%m/%d/%Y'))
...
dr_rain <- read_csv(paste0(wd, '/WetWeatherLoadingCalcs/Input/Rain/SOCWMA_coop_202324.csv'), skip = 3, col_names=c('Time', 'TRABUCO', 'SULPHURCREEK', 'ELTORO', 'PALISADES', 'LAGUNABEACH', 'DANAPOINT', 'TUCKER'))
...
landuse_trib_202324 <- read_csv(paste0(wd, '/trib_lu_area.csv'))  %>%
  #select(-OBJECTID) %>%
...
#landuse_trib_202324$FACILITYID<-sub("J01-9224-1", "J01-9224-1 (J01P24)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("J01-9224-2", "J01-9224-2 (J01P25)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("K01-12177-1", "K01-12177-1 (K01P07)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("L01-766-2", "L01-766-2 (L01S06)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("L02-166-3", "L02-166-3 (L02P26)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("L02-366-1 (L02-P14)", "L02-366-1 (MVL02P14)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("L02-622-2", "L02-622-2 (L02P32)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("L03-662-3", "L03-662-3 (L03P16)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("SC10-075-3", "SC10-075-3 (M00S01)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("J01-10041-2", "J01-10041-2 (J03P13)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("J01-9007-1", "J01-9007-1 (J02P05)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("J01-10004-1", "J01-10004-1 (J01P01)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("I01-11343-2", "I01-11343-2 (I02P18)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("J01-9264-1", "J01-9264-1 (J01P06)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("I01-11216-1", "I01-11216-1 (I02P13)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("J01-9066-1", "J01-9066-1 (J01P04)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("J01-9364-3", "J01-9364-3 (J01P21)",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("L01-728-8", "L01-728-8d",landuse_trib_202324$FACILITYID)
#landuse_trib_202324$FACILITYID<-sub("SC11-035-1", "SC11-035-1d",landuse_trib_202324$FACILITYID)


#filter(HRU_Composite_LSPC_LU_CODE!=80) #remove areas of water bodies

write.table(landuse_trib_202324, file = 'clipboard-16384', sep = '\t')

write_csv(landuse_trib_202324, paste0(wd, '/WetWeatherLoadingCalcs/Output/landuse_trib_202324.csv'))
